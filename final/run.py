...
parser.add_argument('-e', '--epoch', type=int, default=10, help='number of epochs for GAT')
...
def train_autoencoder(train_matrix, test_set):
    ...
    place_correlation = scipy.sparse.load_npz('Foursquare/place_correlation_gamma60.npz')
